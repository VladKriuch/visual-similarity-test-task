...
if __name__ == "__main__":
    ...
    if "pipeline_handler" not in st.session_state:
        st.session_state.pipeline_handler = PipelineHandler(os.path.join(CATEGORIES_FOLDER, "CATEGORIZATION.json"))
    
    if "category_filter" not in st.session_state:
        with open(os.path.join(CATEGORIES_FOLDER, "CATEGORIZATION.json"), "r") as f:
